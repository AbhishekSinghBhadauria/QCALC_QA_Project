...
public class StandardCalculatorTest {
    ...
    //         @Override
    //         public void execute() throws Throwable{
    //             standardCalculator.multiple(Double.MAX_VALUE,Double.MAX_VALUE);
    //         }
    //     });
    // }
    ...
    void testMultipleOperationForDoubles(){
        standardCalculator.multiply(2.0,5.0);
        double actualResult = standardCalculator.getResult();
    ...
    void testDivisionOperationForDoubles(){
        standardCalculator.divide(200.0,10.0);
        double actualResult = standardCalculator.getResult();
